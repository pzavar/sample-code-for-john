    ...
    <View>
      <View >
        ...
        <TouchableOpacity  onPress={()=>props.toggleDrawer()}>
          <ICONS.AntDesign name={'closecircleo'} size={35} color={COLORS.green} style={{backgroundColor:COLORS.white}}/>
        </TouchableOpacity>
        </View>
         */}
      </View>
      {drawerRoutes.map((item, index) => (
        ...
        <Animated.View key={index} style={[pressTab && Number(pressTab.ref) + 1 === index && { transform: [{ translateY: slideAnim2 }] }]}>
