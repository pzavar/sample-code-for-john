export const message={
    ...
    password:{
       ...
       desc: 'Hint: the password should be at least twelve characters long. To make it stronger, use upper and lower case letters, numbers, and symbols like ! " ? $ % ^ & ).'},
    verification:{
        emailSent:'A verification code has been send to your email',
        phoneSent:'A verification code has been send to your phone',
