...
import { addToCart, deleteWishListById } from '../../store/actions';
  ...
  return (
    <View
      ...
      <View style={{ paddingLeft: '3%' }}>
        ...
        <Text style={styles.productTitle}>{data.product_detail.name || data.title} </Text>
       <View style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between', width:wp(50)}}>

      
        <Text>Price: {data.sale_price || data.regular_price || data.price} Rs</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => Alert.alert(
            ...
            [
              ...
              { text: "OK", onPress: () => props.deleteWishListById(data.ID,(data)=> props.setList(data)) }
            ]
...
export default connect(null, { addToCart, deleteWishListById })(WishListCard)
